...
CREATE INDEX idx_meetings_host_id
    ON meetings (host_id);
CREATE INDEX idx_meetings_category_id
    ON meetings (category_id);
CREATE INDEX idx_meetings_status_meeting_date
...
CREATE INDEX idx_meeting_participations_meeting_id
    ON meeting_participations (meeting_id);
CREATE INDEX idx_meeting_participations_member_id
    ON meeting_participations (member_id);
CREATE INDEX idx_meeting_participations_status
...
CREATE INDEX idx_meeting_bookmarks_member_id
    ON meeting_bookmarks (member_id);
CREATE INDEX idx_meeting_bookmarks_meeting_id
...
CREATE INDEX idx_meeting_images_meeting_id
